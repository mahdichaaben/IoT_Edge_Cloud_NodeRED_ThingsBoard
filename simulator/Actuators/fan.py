...
TOPIC_CMD = os.getenv("FAN_TOPIC_CMD", "home/fan/command")
TOPIC_STATE = os.getenv("FAN_TOPIC_STATE", "home/fan/state")
...
if __name__ == "__main__":
    try:
        ...
        print("Fan actuator stopped by user.")
